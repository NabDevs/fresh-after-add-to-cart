...
My role: I developed this plugin from a starter boilerplate, implemented the custom logic, and extended it with AJAX handlers, modal rendering, and product data retrieval. This project demonstrates my ability to build extendable WooCommerce plugins and handle user interactions programmatically.
